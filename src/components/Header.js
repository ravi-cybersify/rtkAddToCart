...
const Header = () => {
  ...
  return (
    <nav class="block w-full px-4 py-2 mx-auto text-white bg-slate-900 shadow-md lg:px-8 lg:py-3 mt-1">
      <div class="flex flex-wrap items-center justify-between mx-20 text-gray-100">
        <div className="flex flex-wrap items-center gap-4 font-semibold">
          <NavLink
            to="/"
            class="mr-4 block cursor-pointer py-1.5 text-base text-gray-200 font-bold"
          >
            E-comm-Redux
          </NavLink>
